  ...
  },
  {
    ...
    "pageTitle": "Style Guide#H1 - Create the best documentation",
    "url": "docs/doc1#code",
    "content": "Copyvar s = 'JavaScript syntax highlighting';alert(s); Copys = \"Python syntax highlighting\"print(s) CopyNo language indicated, so no syntax highlighting.But let's throw in a <b>tag</b>. Copyfunction highlightMe() { console.log('This line can be highlighted!');}  "
  },
  {
    "title": "Tables",
    "type": 1,
  ...
  },
  {
    ...
    "content": "React adalah Framework Javascript. Menggunakan Framework semudah menambahkan file Javascript ke file HTML dan gunakan React Export di aplikasi. Misalkan, Hello World, dalam React website tertulis seperti ini: Copy<body> <div id=\"app\"></div> <script type=\"text/javascript\"> ReactDOM.render( <h1>Hello World</h1>, document.querySelector('#app') ) </script></body> Wow, sedikit menakutkan, Kode JavaScript ditambahkan “Hello World” dalam baris yang dapat dirubah. Harap dicatat, kita hanya menambahkan script JavaScript agar dapat bekerja. "
  },
  {
  ...
  },
  {
    ...
    "content": "Selamat menikmati buku translate tentang ReactJS, translate secara manual dengan pemahaman saya sendiri, jika ada yang salah atau kurang pas silahkan pull atau email ke saya di desta@rsuppersahabatan.co.id dengan senang hati saya akan perbaiki. Saya juga menerima Jasa Pembuatan Manual Book untuk Private Company dengan Teknologi Docusaurus (ReactJS). Implementasi manual book di RSUP Persahabatan juga dibuat dengan Docusaurus, mohon maaf akses hanya bisa melalui jaringan lokal. Sekian, Wassalam. Copyconsole.log('emang_dasar a.k.a topidesta'); "
  },
  {
